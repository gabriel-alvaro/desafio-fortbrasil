...
Aqui, foram feitos os devidos tratamentos e cálculos necessários para obtermos o percentual de faturas cujo cliente associado não pagou a fatura do mês anterior.  O resultado obtido foi resumido abaixo para melhor visualização. fornecido.
...
```{r, eval = TRUE, echo = FALSE, out.width = "700px", fig.align = "center"}
...
Podemos carregar a base de dados criada para verificar se foram salvos da maneira correta:
...
O script utilizado (*q3_queries.R*) bem como um arquivo de texto somente com as queries (**)
